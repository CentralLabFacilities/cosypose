...
for dir in os.listdir(site_pkgs):
    if 'promt' in dir:
        sys.path.append(os.path.join(site_pkgs, dir))
...
scene_ds = make_scene_dataset(ds_name, '/home/bv-user/cosypose-ordner/keyframe.txt')
